...
|---|---|---|---|
| `default` | B0 | OSNet | 0,55 / 0,65; Schärfe 0,40 / 0,70 |
| `colorhist` | A1 | HSV-Farbhistogramm | 0,55 / 0,65; Schärfe 0,40 / 0,70 |
| `no_quality_thresholds` | A2 | OSNet | 0 / 0 |
| `no_update_similarity` | A3 | OSNet | 0,55 / 0,65; Schärfe 0,40 / 0,70 |
| `details_tracking` | D1 | OSNet + vollständige Details-Policy | 0,55 / 0,65; Schärfe 0,40 / 0,70 |
| `details_no_reranking` | D2 | D1 ohne Detail-Re-Ranking | 0,55 / 0,65; Schärfe 0,40 / 0,70 |
| `details_no_weak_zone` | D3 | D1 ohne Weak-Zone | 0,55 / 0,65; Schärfe 0,40 / 0,70 |
| `details_immediate_new_person` | D4 | D1 ohne verzögerte Neuanlage | 0,55 / 0,65; Schärfe 0,40 / 0,70 |
| `details_no_overlap_protection` | D5 | D1 ohne Überlappungsschutz | 0,55 / 0,65; Schärfe 0,40 / 0,70 |
| `details_no_motion_bonus` | D6 | D1 ohne Motion-Bonus | 0,55 / 0,65; Schärfe 0,40 / 0,70 |

Alle Presets verwenden zunächst YOLOv8n, ByteTrack, Cosine-Schwellwert 0,75,
Detektionskonfidenz 0,35, Eingangsgröße 640, fünf Initialbeobachtungen im Abstand
von drei Frames und Updates alle fünf Frames. Die Mindest-Crop-Größe beträgt
30 x 80 Pixel.
